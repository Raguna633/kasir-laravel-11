...
<body onload="window.print()">
    ...
    <p style="float: left">Tipe Pembelian:</p>
    <p style="float: right; text-transform: capitalize;" >{{ $penjualan->tipe_pembeli }}</p>
    <div class="clear-both" style="clear: both;"></div>
    ...
    <table width="100%" style="border: 0;">
        @foreach ($detail as $item)
            @php
                ...
                // Hitung subtotal
                $subtotal = $item->jumlah * $harga_jual;
            @endphp
            ...
            <tr>
                <td>{{ $item->jumlah }} {{ $item->produkSatuan->satuan ?? '' }} x {{ format_uang($harga_jual) }}</td>
                <td></td>
